    ...
    "Lists": [
        {
            ...
            "Columns": [
                { "DataProperty": "Id" },
                { "DataProperty": "CodigoOT", "ReplacedBy": "O", "Descriptible": true },
                ...
                { "DataProperty": "FechaRecepcion", "ReplacedBy": "R", "HiddenMobile": true, "Expand": true },
                { "DataProperty": "FechaInicio", "ReplacedBy": "I", "HiddenMobile": true, "Expand": true },
                { "DataProperty": "FechaCertificacion", "ReplacedBy": "Cr", "HiddenMobile": true, "Expand": true },
    ...
    "Forms": [
        {
            ...
            "Tabs": [
                ...
                },*/
                {
                    ...
                    "Label": "Dades",
                    "Buttons": [
                        { "Name": "ShowMap", "Label": "Veure al mapa", "Group": 1, "Function": "ShowMap", "Icon": "fa-map-marker" },
                        { "Name": "GeoCode", "Label": "Imprimir PDF", "Group": 2, "Function": "Geocode", "Icon": "fa-calendar" },
                        { "Name": "ShowMap", "Label": "Imprimir resumend", "Group": 2, "Function": "ShowMap", "Icon": "fa-pencil" },
                        { "Name": "GeoCode", "Label": "Enviar por mail", "Group": 3, "Function": "Geocode" },
                        { "Name": "GeoCode", "Label": "Obtenir coordenades", "Group": 1, "Function": "Geocode" },
                        { "Name": "ShowMap", "Label": "Duplicar", "Group": 4, "Function": "ShowMap" }
                    ],
                    "Rows": [
                        {
                            "Label": "Adjudicació",
                            "Fields": [
                                { "Name": "AdjudicacionId" },
                                { "Name": "ClientePropietarioId", "Label": "Propietat" , "Type":"text", "Required": true, "ReadOnly": true}
                            ]
                        },
                        {
                            "Label": "Direcció",
