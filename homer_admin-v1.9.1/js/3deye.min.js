(function(e) {
    ...
    e.vc3dEye = function(t, n) {
        ...
        function v() {
			...
			e(u).css("background-size", "cover");
			e(u).css("background-repeat", "no-repeat");
			e(u).css("background-position", "center center");
            e("<img/>").attr("src", t).load(function() {
                e(u).height(h || this.height).width(w || this.width)
            });
            for (var n = 2; n <= i; n++) {
                t = a + n + "." + c;
        ...
        function m() {
            e("html").append("<style type=\"text/css\">.onLoadingDiv{background-color:#eef;opacity:0.5;text-align:center;font-size:2em;font:color:#000;}</style>")
        }
        var r = 1,
            i = 0,
            s = false,
        ...
        h(t, n);
        m();
        e(u).html("<div id=\"VCc\" style=\"height:100%;width:100%;\" class=\"onLoadingDiv\">" + Dictionary.Common_Loading + "...</div>");
        v();
        p()
    }
})(jQuery)